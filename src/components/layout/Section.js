...
export default function Section() {
  ...
  const sectionItems = [
    ...
    },
    {
      ...
      sentence:
        "With step-by-step instructions and video tutorials, Digital Fuse empowers seniors to become tech-savvy. Join us today and start your journey to digital success!",
    },
  ];
  return (
